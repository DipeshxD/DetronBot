...
#RUN git clone -b main https://github.com/xdipesh/DetronBot/root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/xdipesh/DetronBot/main/Danny.py
RUN wget https://raw.githubusercontent.com/xdipesh/DetronBot/main/requirements.txt
RUN pip3 install -r requirements.txt
#CMD ["python3","-m","userbot"]
CMD ["python3","Danny.py"]
