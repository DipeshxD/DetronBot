...
async def a():
  ...
  LOGS.info(f"Sucessfully connected with {o}{o2}{o3}{o4} check it by typing !DetronBot in any client's chat, type  .help for more info. For official plugin channel for DetronBot got to and for more expirementaal plugin goto @plugines Also U Should Thank to All Contributers in repo:https://github.com/xdipesh/DetronBot")

  if len(argv) not in (1, 3, 4):
       await DetronBot.disconnect()
  else:
       await DetronBot.run_until_disconnected()
       

        

DetronBot.loop.run_until_complete(a())
