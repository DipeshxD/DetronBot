...
from userbot.events import DetronBot05, rekcah05, progress, humanbytes, time_formatter
from userbot import CMD_HELP, ALIVE_NAME, PM_MESSAGE, DetronBot_NAME, DetronBot_MSG, ORI_MSG, bot as DetronBot
...
@DetronBot.on(rekcah05(pattern=f"song2(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!song2(?: |$)(.*)")
async def _(event):
...
@DetronBot.on(rekcah05(pattern=f"info(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!info(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"lyrics2(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!lyrics2(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"fry(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!fry(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot05(outgoing=True, pattern="^!ss2(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"ss3(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!ss3(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"ss4(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!ss4(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"mask(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!mask(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"ushort(?: |$)(.*)", allow_sudo=True))
@DetronBot05(outgoing=True, pattern="^!ushort(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
...
@DetronBot.on(rekcah05(pattern=f"ss(?: |$)(.*)", allow_sudo=True))
@DetronBot(outgoing=True, pattern="^!ss(?: |$)(.*)")
async def _(event):
  sender = await event.get_sender() ; me = await event.client.get_me()
  if not sender.id == me.id:
        rkp = await event.reply("`processing...`")
